                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.subcategories.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category_id" id="category_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md text-gray-900" required>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('admin.subcategories.index') }}" class="text-gray-600 hover:text-gray-900 mr-4">Cancel</a>
